...
- Codex reviews automatically when a PR opens ready or a draft is marked ready — opening ready is itself the trigger. Comment `@codex review` to re-trigger after pushing fixes.
