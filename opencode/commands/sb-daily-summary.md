...
- Headless equivalent for shell/cron use:
  `opencode run "Summarize my merged PRs and closed Linear issues from the last 24 hours. Output: (1) a 3-sentence Slack blurb in plain language, no code, (2) a bulleted link list of PRs and Linear tickets, (3) any manual follow-ups still outstanding."`