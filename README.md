...
plus four spread colors — olive, forest, rust and petrol — that keep the hash pool from leaning pink once the reserved
five are held back. Seed it once on a new Mac (the script falls back to the same row when the
default is unset, but the right-click menu would still show iTerm's stock colors):

```sh
defaults write com.googlecode.iterm2 TabColorMenuOptions -string '#dc2626 #d77757 #ffdf39 #4eba65 #4782c8 #af87ff #888888 #ff0087 #48968c #00cccc #ca8a04 #c46686 #93a5ff #ffffff #2b2b2b #808000 #2f7d4f #b45309 #1f6f8b'
```
